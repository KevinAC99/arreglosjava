...
public class Gato extends Animal {
    ...
    public float peso; //tipo de dato más pequeño que el double
    ...
    public Gato(String color, float tamanio, float peso, String nombre, String raza) {
        this.color = color;
        this.tamanio = tamanio;
        this.peso = peso;
        this.nombre = nombre;
